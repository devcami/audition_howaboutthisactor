...
/**
 * Servlet implementation class IngReportListServlet
 */
@WebServlet("/mypage/ingReportList")
public class IngReportListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("IngReportListServlet@totalContent = " + totalContent);
			int cPage = 1; 
			...
			System.out.println("IngReportListServlet@list 길이 = " + list.size());
			System.out.println("IngReportListServlet@list.get(0) = " + list.get(0));
			System.out.println("IngReportListServlet@list.get(1) = " + list.get(1));
			System.out.println("IngReportListServlet@list.get(2)" + list.get(2));
