...
public class Actor {
		...
		public Actor(String memberId, String actorName, int actorNo, String birth, int age, String education,
		...
		public String toString() {
			return "Actor [memberId=" + memberId + ", actorName=" + actorName + ", actorNo=" + actorNo + ", birth="
