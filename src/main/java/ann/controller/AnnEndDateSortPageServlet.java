...
/**
 * Servlet implementation class AnnEndDateSortPageServlet
 */
@WebServlet("/ann/endDatePage")
public class AnnEndDateSortPageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			// 2. 업무로직
			List<Ann> list = annService .endDatePage(param);
